  ...
  def create
    ...
    respond_to do |format|
      if @admin_product.save
        ...
        format.json { render :show, status: :created, location: [:admin, @admin_product] }
      else
  ...
  def update
    respond_to do |format|
      if @admin_product.update(admin_product_params)
        ...
        format.json { render :show, status: :ok, location: [:admin, @admin_product] }
      else
        format.html { render :edit, status: :unprocessable_entity }
        format.json { render json: [:admin, @admin_product].errors, status: :unprocessable_entity }
      end
    end
  end
